...
export class CreateDatabase1740535253700 implements MigrationInterface {
  name = 'CreateDatabase1740535253700';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`skill\` (\`id\` varchar(36) NOT NULL, \`name\` varchar(255) NOT NULL, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_0f49a593960360f6f85b692aca\` (\`name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE \`user_skill\` (\`skill_id\` varchar(36) NOT NULL, \`user_id\` varchar(36) NOT NULL, INDEX \`IDX_215460dc28b2f3cb6507c315eb\` (\`skill_id\`), INDEX \`IDX_e4ba866607554d86dc9c2a6c0e\` (\`user_id\`), PRIMARY KEY (\`skill_id\`, \`user_id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `ALTER TABLE \`user\` ADD \`expected_salary\` decimal(10,2) NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`user_skill\` ADD CONSTRAINT \`FK_215460dc28b2f3cb6507c315eb3\` FOREIGN KEY (\`skill_id\`) REFERENCES \`skill\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE \`user_skill\` ADD CONSTRAINT \`FK_e4ba866607554d86dc9c2a6c0e3\` FOREIGN KEY (\`user_id\`) REFERENCES \`user\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE \`user_skill\` DROP FOREIGN KEY \`FK_e4ba866607554d86dc9c2a6c0e3\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`user_skill\` DROP FOREIGN KEY \`FK_215460dc28b2f3cb6507c315eb3\``,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`user\` DROP COLUMN \`expected_salary\``,
    );
    await queryRunner.query(
      `DROP INDEX \`IDX_e4ba866607554d86dc9c2a6c0e\` ON \`user_skill\``,
    );
    await queryRunner.query(
      `DROP INDEX \`IDX_215460dc28b2f3cb6507c315eb\` ON \`user_skill\``,
    );
    ...
    await queryRunner.query(
      `DROP INDEX \`IDX_0f49a593960360f6f85b692aca\` ON \`skill\``,
    );
